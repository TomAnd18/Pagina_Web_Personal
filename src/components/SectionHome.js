...
import miCV from '../pdf/CVTomasRegalado.pdf';
    ...
    <div className='container-global-sectionhome'>
        ...
        <div className='datos-container-sectionhome'>
            ...
            <div className='misredes-sectionhome-low'>
              <a href='https://www.linkedin.com/in/tomas-regalado/' target='_blank' rel="noopener noreferrer" className='btn-low-redes'> <FontAwesomeIcon style={{width: '100%', height: '100%'}} icon={faLinkedin} /> </a>
            ...
            <a className='btn-cv-download' href={miCV} download={'CVTomasRegalado.pdf'}>
